...
export const createMaintenanceSchema = z.object({
  body: z.object({
    ...
    receiptUrl: z.string().url("Invalid receipt URL").or(z.literal("")).optional().nullable(),
    nextServiceOdometer: z.number().min(0).nullable().optional(),
    nextServiceOdometerMin: z.number().min(0).nullable().optional(),
    nextServiceOdometerMax: z.number().min(0).nullable().optional(),
