...
export function FuelStatCards({ fuelExpenses = [], isLoading = false }) {
  ...
  // Compute total distance traveled between refills
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {/* Total Spend */}
      <Card className="border-border/50 bg-card/50 backdrop-blur-xl transition-all hover:shadow-lg hover:border-primary/20">
      ...
      {/* Total Fuel Volume */}
      <Card className="border-border/50 bg-card/50 backdrop-blur-xl transition-all hover:shadow-lg hover:border-amber-500/20">
        <CardContent className="p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-foreground">{totalVolume.toFixed(1)} L</h3>
          </div>
        </CardContent>
      </Card>

      {/* Average Mileage (Fuel Economy) */}
      <Card className="border-border/50 bg-card/50 backdrop-blur-xl transition-all hover:shadow-lg hover:border-cyan-500/20">
        <CardContent className="p-5 flex items-center gap-4">
      ...
      {/* Cost Per Kilometer */}
      <Card className="border-border/50 bg-card/50 backdrop-blur-xl transition-all hover:shadow-lg hover:border-purple-500/20">
        <CardContent className="p-5 flex items-center gap-4">
